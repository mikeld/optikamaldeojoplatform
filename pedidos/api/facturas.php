...
5. u (unitPrice) must ALWAYS be the final NET unit price AFTER discounts: u = lt / q (lt is the last 'Importe'/net column). If there is a discount column (DESC. %, Dto.), ALSO report the percent in dp, but u stays the net unit price — never the pre-discount tariff. Preserve decimals exactly.
